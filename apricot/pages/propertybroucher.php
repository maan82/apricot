...
$PROPERTY_FOR_ID = $row_prop_details_RS['PROPERTY_FOR_ID'];
?>
<?php
require('fpdf.php');
...
function Header()
{
    global $PROPERTY_FOR_ID;
	//Logo
	if ($PROPERTY_FOR_ID == 2)
		$this->Image('images/new-images/aeon-lettings-pdf.jpg',0,0,210);
	else
		$this->Image('images/new-images/aeon-sales-pdf.jpg',0,0,210);
...
function Footer()
{
	global $PHONE;
	global $EMAIL_SALES;
	global $EMAIL_LETTINGS;
	global $ADDRESS_LINE1;
	global $ADDRESS_LINE2;
	global $PROPERTY_FOR_ID;
	
	if ($PROPERTY_FOR_ID == 2)
		$EMAIL = $EMAIL_LETTINGS;
	else 
		$EMAIL = $EMAIL_SALES;
	...
	$this->Cell(0,5,'www.aeonestates.com',0,1,'C',true,'http://www.aeonestates.com/');
	//Arial italic 8
...
$pdf->MultiCell($cellWidth,5,$row_prop_details_RS['TYPE_SHORT_DESCRIPTION']." ".$row_prop_details_RS['FOR_SHORT_DESCRIPTION']." ".number_format( $row_prop_details_RS['PRICE'])." ".$row_prop_details_RS['CITY']." ".$row_prop_details_RS['BEDROOMS']." ".$row_prop_details_RS['COUNTRY']);
...
$pdf->Image($row_prop_details_RS['FULL_PIC_PATH'],null,null,190.00, null, null);
