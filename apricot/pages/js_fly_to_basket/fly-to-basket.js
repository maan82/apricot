...
function addToBasket(productId)
{
	...
	if(productRow){
		alert("You have already shortlisted this property.");
		return;
	}
...
{
	document.getElementById('compare_list').style.display = 'inline';
...
{
	if(ajaxObjects[ajaxIndex].response!='OK')alert(ajaxObjects[ajaxIndex].response);
