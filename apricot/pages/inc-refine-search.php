...
<div class="block" style="width: 100%">
 <div class="heading">
 	 Refine Property Search<img src="images/home-search-icon.png" height="20" style="float:right"/>
 </div>           
<form action="searchresults.php" method="get" name="form_quicksearch" enctype="application/x-www-form-urlencoded">
  
  <div align="center" class="form label" cellpadding="0" cellspacing="0" style="margin:0px;width:100%">
                    <div valign="baseline">
                      <div   class="label" style="font-family:Arial, Helvetica, sans-serif">
                        <label class="label">
                    ...
                    <div valign="baseline">
                      <div   class="label" >Property Type :<br />
